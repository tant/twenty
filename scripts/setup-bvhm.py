...
PERSON_FIELDS = [
    ...
    {"name": "trigger", "label": "Trigger", "type": "TEXT", "icon": "IconFlask", "description": "Loại thuốc kích (VD: Cetrotide)"},
    {"name": "receptionDate", "label": "Ngày tiếp đón", "type": "DATE", "icon": "IconCalendarEvent"},
    {"name": "treatmentDays", "label": "Số ngày điều trị", "type": "NUMBER", "icon": "IconHourglass"},
    {"name": "babyDob", "label": "Ngày sinh bé", "type": "DATE_TIME", "icon": "IconBabyCarriage", "description": "Ngày giờ sinh (khoa Sản)"},
    {"name": "babyGender", "label": "Giới tính bé", "type": "SELECT", "icon": "IconGenderBigender",
     "options": [{"label": "Trai", "value": "TRAI", "position": 0, "color": "blue"},
                 {"label": "Gái", "value": "GAI", "position": 1, "color": "red"}]},
    {"name": "babyWeight", "label": "Cân nặng bé", "type": "NUMBER", "icon": "IconScale", "description": "Gram"},
...
TASK_FIELDS = [
    ...
    {"name": "callNote", "label": "Ghi chú chăm sóc", "type": "TEXT", "icon": "IconNote", "description": "Kết quả liên lạc: gọi/nhắn tin"},
    {"name": "taskNote", "label": "Ghi chú", "type": "TEXT", "icon": "IconFileText", "description": "Thông tin bổ sung về ca này"},
    {"name": "importantNote", "label": "Lưu ý", "type": "TEXT", "icon": "IconAlertCircle", "description": "Cảnh báo quan trọng cần chú ý khi gọi"},
